...
namespace Infrastructure.Data
{
    public class MovieShopDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Crew>(ConfigureCrews);
            modelBuilder.Entity<MovieCrew>(ConfigureMovieCrews);
        }
        ...
        private void ConfigureMovieCrews(EntityTypeBuilder<MovieCrew> builder)
        {
        ...
        private void ConfigureCrews(EntityTypeBuilder<Crew> builder)
        {
